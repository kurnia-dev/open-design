...
export const ja: Dict = {
  ...
  'designs.deleteConfirmWithDs': '「{name}」を削除してもよろしいですか？このプロジェクトはデザインシステムと連動しており、削除すると関連するデザインシステムとすべてのドラフトファイルも削除されます。',
  ...
  'designs.deleteSelectedConfirmWithDs': '選択した {n} 個のプロジェクトを削除してもよろしいですか？選択されたプロジェクトにはデザインシステムと連動するものが含まれており、削除すると関連するデザインシステムとドラフトファイルも削除されます。',
  ...
  'settings.designSystemsImportGit': 'Git からインポート',
  ...
  'dsManager.importGitTitle': 'Git からインポート',
  'dsManager.importGitBody': '既存のデザインシステムリポジトリをクローンしてインポートします。',
  'dsManager.importGitAction': 'インポート',
  ...
  'dsManager.deleteModalTitle': 'デザインシステムを削除',
  'dsManager.deleteModalConfirm': '「{title}」を削除してもよろしいですか？このデバイスからドラフトデザインシステムが削除されます。',
  'dsManager.deleteModalDirtyTitle': 'ワーキングツリーがクリーンではありません',
  'dsManager.deleteModalDirtyWarning': 'Git ワーキングツリーがクリーンではありません。削除すると未コミットの変更が失われます。',
  'dsManager.deleteModalForceDelete': '強制削除',
