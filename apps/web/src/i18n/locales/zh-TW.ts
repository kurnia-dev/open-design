...
export const zhTW: Dict = {
  ...
  'designs.deleteConfirmWithDs': '確定要刪除「{name}」嗎？此專案是設計系統的後盾，刪除它也將刪除關聯的設計系統及其所有草稿檔案。',
  ...
  'designs.deleteSelectedConfirmWithDs': '確定要刪除這 {n} 個專案嗎？選取的專案中包含一個或多個與設計系統關聯的專案，刪除它們也將刪除關聯的設計系統及其所有草稿檔案。',
  ...
  'settings.designSystemsImportGit': '從 Git 匯入',
  ...
  'dsManager.importGitTitle': '從 Git 匯入',
  'dsManager.importGitBody': '複製並匯入現有的設計系統存放庫。',
  'dsManager.importGitAction': '匯入',
  ...
  'dsManager.deleteModalTitle': '刪除設計系統',
  'dsManager.deleteModalConfirm': '確定要刪除「{title}」嗎？這將從此裝置中刪除草稿設計系統。',
  'dsManager.deleteModalDirtyTitle': '工作區不乾淨',
  'dsManager.deleteModalDirtyWarning': 'Git 工作區未提交，如果刪除，未提交的變更將會遺失。',
  'dsManager.deleteModalForceDelete': '強制刪除',
