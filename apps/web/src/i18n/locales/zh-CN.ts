...
export const zhCN: Dict = {
  ...
  'designs.deleteConfirmWithDs': '确定要删除“{name}”吗？此项目是设计系统的后盾，删除它也将删除关联的设计系统及其所有草稿文件。',
  ...
  'designs.deleteSelectedConfirmWithDs': '确定要删除这 {n} 个项目吗？选中的项目中包含一个或多个与设计系统关联的项目，删除它们也将删除关联的设计系统及其所有草稿文件。',
  ...
  'settings.designSystemsImportGit': '从 Git 导入',
  ...
  'dsManager.importGitTitle': '从 Git 导入',
  'dsManager.importGitBody': '克隆并导入现有的设计系统仓库。',
  'dsManager.importGitAction': '导入',
  ...
  'dsManager.deleteModalTitle': '删除设计系统',
  'dsManager.deleteModalConfirm': '确定要删除“{title}”吗？这将从该设备中删除草稿设计系统。',
  'dsManager.deleteModalDirtyTitle': '工作区不干净',
  'dsManager.deleteModalDirtyWarning': 'Git 工作区未提交，如果删除，未提交的更改将会丢失。',
  'dsManager.deleteModalForceDelete': '强制删除',
