...
export const ru: Dict = {
  ...
  'settings.designSystemsImportGit': 'Импортировать из Git',
  ...
  'dsManager.importGitTitle': 'Импортировать из Git',
  'dsManager.importGitBody': 'Клонировать и импортировать существующий репозиторий системы дизайна.',
  'dsManager.importGitAction': 'Импорт',
