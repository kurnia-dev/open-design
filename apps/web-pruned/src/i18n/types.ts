// Reference: apps/web/src/i18n/types.ts
...
export interface Dict {
  ...
  'settings.githubHint': string;
  'settings.githubTitle': string;
  'settings.githubBody': string;
  'settings.githubPat': string;
  'settings.githubPatPlaceholder': string;
  'settings.githubConnect': string;
  'settings.githubConnecting': string;
  'settings.githubDisconnect': string;
  'settings.githubConnected': string;
  'settings.githubNotConnected': string;
  'settings.githubPatHint': string;
  'settings.githubMenuLabel': string;
  'settings.githubMenuHint': string;
  'settings.githubIntegrationTitle': string;
  'settings.githubDisconnecting': string;
  'settings.githubIntegrationHint': string;
  'settings.githubStatus': string;
  'settings.githubLoading': string;
  'settings.githubAuthorizeTitle': string;
  'settings.githubAuthorizeHint': string;
  'settings.githubCopyCode': string;
  'settings.githubOpenAuthorize': string;
  'settings.githubWaitingAuth': string;
  'settings.githubStarting': string;
  'settings.githubAltPatTitle': string;
  'settings.githubAltPatHint': string;
  'settings.githubPatError': string;
  'settings.githubNetworkError': string;
  'settings.githubExpired': string;
  'settings.githubDenied': string;
  'settings.githubVerifyError': string;
  'settings.githubLoginError': string;
  ...
  'workspace.gitRefresh': string;
  'workspace.gitSync': string;
  'workspace.gitGithubNotice': string;
  'workspace.gitCommitPlaceholder': string;
  'workspace.gitCommitGenerate': string;
  'workspace.gitCommitBtn': string;
  'workspace.gitChangesStaged': string;
  'workspace.gitChangesUntracked': string;
  'workspace.gitChangesUnstaged': string;
  'workspace.gitNoChanges': string;
  'workspace.gitStageAll': string;
  'workspace.gitUnstageAll': string;
  'workspace.gitStage': string;
  'workspace.gitUnstage': string;
  'workspace.gitDiscard': string;
  'workspace.gitDiscardConfirmTitle': string;
  'workspace.gitDiscardConfirmBody': string;
  'workspace.gitViewDiff': string;
  ...
  'github.repoCreate.ownerLabel': string;
  'github.repoCreate.selectOwner': string;
  'github.repoCreate.chooseOwner': string;
  'github.repoCreate.searchOwners': string;
  'github.repoCreate.noOwners': string;
  'github.repoCreate.nameLabel': string;
  'github.repoCreate.namePlaceholder': string;
  'github.repoCreate.checkingAvailability': string;
  'github.repoCreate.available': string;
  'github.repoCreate.taken': string;
  'github.repoCreate.checkFailed': string;
  'github.repoCreate.suggestionPrefix': string;
  'github.repoCreate.visibilityLabel': string;
  'github.repoCreate.privateLabel': string;
  'github.repoCreate.privateDesc': string;
  'github.repoCreate.publicLabel': string;
  'github.repoCreate.publicDesc': string;
