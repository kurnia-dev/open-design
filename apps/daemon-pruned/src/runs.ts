...
export function createChatRunService({
    ...
    const run = {
      ...
      clientRequestId:
        typeof meta.clientRequestId === "string" && meta.clientRequestId
          ...
          : null,
      agentId:
        typeof meta.agentId === "string" && meta.agentId ? meta.agentId : null,
      ...
      appliedPluginSnapshotId:
        typeof meta.appliedPluginSnapshotId === "string" &&
        meta.appliedPluginSnapshotId
          ? meta.appliedPluginSnapshotId
          : null,
      pluginId:
        typeof meta.pluginId === "string" && meta.pluginId
          ? meta.pluginId
          : null,
      ...
      eventsLogPath: runsLogDir
        ? path.join(runsLogDir, id, "events.jsonl")
        : null,
  ...
  const ensureLogStream = (run) => {
    ...
    try {
      ...
      run.eventsLogStream = fs.createWriteStream(run.eventsLogPath, {
        flags: "a",
      });
