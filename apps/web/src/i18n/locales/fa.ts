...
export const fa: Dict = {
  ...
  'dsManager.importGitTitle': 'درون‌ریزی از Git',
  'dsManager.importGitBody': 'کلون و وارد کردن یک مخزن سیستم طراحی موجود.',
  'dsManager.importGitAction': 'وارد کردن',
