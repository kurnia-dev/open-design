...
export const en: Dict = {
  ...
  'newproj.framework.reactWeb.hint': 'Responsive web app with React, Vite, TypeScript, and Tailwind CSS',
  'newproj.framework.reactNative.label': 'React Native (Mobile)',
  'newproj.framework.reactNative.hint': 'Cross-platform iOS/Android app with Expo and React Native',
  ...
  'designs.deleteConfirmWithDs': 'Delete "{name}"? This project is backing a design system. Deleting it will also delete the associated design system and all its draft files.',
  ...
  'designs.deleteSelectedConfirmWithDs': 'Delete {n} project(s)? One or more selected projects are backing a design system. Deleting them will also delete their associated design systems and draft files.',
  ...
  'fileViewer.rotateDevice': 'Rotate device',
  'fileViewer.rotateDeviceTitle': 'Rotate device',
  ...
  'dsManager.importGitTitle': 'Import from Git',
  'dsManager.importGitBody': 'Clone and import an existing design system repository.',
  'dsManager.importGitAction': 'Import',
  ...
  'dsManager.deleteModalTitle': 'Delete Design System',
  'dsManager.deleteModalConfirm': 'Are you sure you want to delete "{title}"? This removes the draft design system from this device.',
  'dsManager.deleteModalDirtyTitle': 'Working tree not clean',
  'dsManager.deleteModalDirtyWarning': 'The Git working tree is not clean. Uncommitted changes will be lost if deleted.',
  'dsManager.deleteModalForceDelete': 'Force Delete',
  ...
  'github.repoCreate.ownerLabel': 'Owner',
  'github.repoCreate.selectOwner': 'Select Owner',
  'github.repoCreate.chooseOwner': 'Choose an owner',
  'github.repoCreate.searchOwners': 'Search owners',
  'github.repoCreate.noOwners': 'No owners found',
  'github.repoCreate.nameLabel': 'Repository name',
  'github.repoCreate.namePlaceholder': 'Repository name',
  'github.repoCreate.checkingAvailability': 'Checking availability...',
  'github.repoCreate.available': '{name} is available',
  'github.repoCreate.taken': 'Repository name is already taken.',
  'github.repoCreate.checkFailed': 'Failed to check availability.',
  'github.repoCreate.suggestionPrefix': 'How about',
  'github.repoCreate.visibilityLabel': 'Visibility',
  'github.repoCreate.privateLabel': 'Private',
  'github.repoCreate.privateDesc': 'Only you can see this repository.',
  'github.repoCreate.publicLabel': 'Public',
  'github.repoCreate.publicDesc': 'Anyone on the internet can see this repository.',
  ...
  'publish.creatingTitle': 'Creating your design system...',
  'publish.creatingDesc': 'Keep this tab open. You can come back in a few minutes.',
  'publish.titleError': 'Publishing failed',
  'publish.titleSuccess': 'Design system published!',
  'publish.titleRunning': 'Publishing your design system...',
  'publish.descError': 'Review the error logs below to diagnose the issue.',
  'publish.descSuccess': 'Your design system packages are published to npm registry successfully.',
  'publish.descRunning': 'Keep this tab open. We are running the build and publishing to npm registry.',
  'publish.consoleLogs': 'Console Logs',
  'publish.runningState': 'Running',
  'publish.backToWorkspace': 'Back to Workspace',
};
